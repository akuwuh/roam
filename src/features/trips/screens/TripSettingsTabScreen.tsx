/**
 * Trip Settings Tab Screen - Wrapper for use in bottom tabs
 */
...
type Props = CompositeScreenProps<
  BottomTabScreenProps<TripTabsParamList, 'Settings'>,
  NativeStackScreenProps<RootStackParamList>
>;

export function TripSettingsTabScreen({ navigation, route }: Props) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Saved', 'Trip settings have been updated.');
    } finally {
      setIsSaving(false);
    }
  };
